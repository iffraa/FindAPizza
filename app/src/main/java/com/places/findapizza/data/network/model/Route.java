...
public class Route {
	...
	public Document getDocument(LatLng start, LatLng end, String mode,Context context) {
	...
	@SuppressLint("NewApi") public String getDurationText(Document doc) {
	    try {
	...
	@SuppressLint("NewApi") public int getDurationValue(Document doc) {
	    try {
	        NodeList nl1 = doc.getElementsByTagName("duration");
	        Node node1 = nl1.item(0);
	        NodeList nl2 = node1.getChildNodes();
	...
	@SuppressLint("NewApi") public String getDistanceText(Document doc) {
	    /*
	...
	@SuppressLint("NewApi") public int getDistanceValue(Document doc) {
	    try {
	...
	@SuppressLint("NewApi") public String getStartAddress(Document doc) {
	    try {
	...
	@SuppressLint("NewApi") public String getEndAddress(Document doc) {
	    try {
	...
	@SuppressLint("NewApi") public String getCopyRights(Document doc) {
	    try {
	...
	@SuppressLint("NewApi") public ArrayList<LatLng> getDirection(Document doc) {
